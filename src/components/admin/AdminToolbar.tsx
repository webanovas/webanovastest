    ...
    return (
      <AnimatePresence>
        <motion.div
          ...
          className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1.5 bg-card/95 backdrop-blur-xl border border-border shadow-2xl rounded-full px-2.5 py-2"
        >
          <Button
            size="sm"
