    ...
    <Layout>
      ...
      <section className="py-4 px-4">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
          {[heroYoga, yogaGroup, studioInterior, meditationHands, yogaSunset, teacherShira].map((img, i) => (
            <motion.div
              key={i}
            ...
            >
              <img src={img} alt={`סטודיו ${i + 1}`} className="w-full aspect-square object-cover hover:scale-105 transition-transform duration-700" />
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="relative h-[50vh] overflow-hidden">
        <img src={yogaSunset} alt="יוגה" className="w-full h-full object-cover" />
