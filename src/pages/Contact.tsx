          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 max-w-5xl mx-auto">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={fadeUp} className="rounded-2xl overflow-hidden shadow-md border border-border/30">
                <img src={studioInterior} alt="מפה - כיכר המושבה הוד השרון" className="w-full aspect-video object-cover" />
              </motion.div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-4">
                ...
                <motion.div variants={fadeUp}>
                  <Textarea placeholder="הודעה" rows={5} className="bg-accent/30 border-0 rounded-xl" />
                </motion.div>
                <motion.div variants={fadeUp}>
