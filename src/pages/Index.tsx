  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-dvh md:min-h-screen flex items-end overflow-hidden">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-2xl">
            ...
            <motion.div variants={fadeUp}>
              <E section="hero-subtitle" fallback="מקום של שקט, נשימה וחיבור. בואו לתרגל במרחב חם ומזמין עם שירה פלג וצוות המורים שלנו." as="p"
                className="text-base md:text-xl text-primary-foreground/75 leading-relaxed mb-8 md:mb-10 max-w-lg font-light" multiline />
            </motion.div>
        ...
        {/* Scroll-down arrow */}
        <motion.div
          className="absolute bottom-28 md:bottom-8 left-1/2 -translate-x-1/2 z-10 cursor-pointer"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
