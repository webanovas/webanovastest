...
const services = [
  { icon: Users, title: "שיעורים בסטודיו", desc: "שיעורי יוגה קבוצתיים באווירה חמה ומזמינה", image: yogaGroup },
  { icon: Monitor, title: "שיעורי זום", desc: "תרגלו מהנוחות של הבית בשיעורים אונליין", image: zoomYoga },
  { icon: User, title: "שיעורים פרטיים", desc: "תרגול מותאם אישית לצרכים שלכם", image: privateLesson },
  { icon: Heart, title: "קבוצות מיוחדות", desc: "שיעורים לקבוצות, ימי כיף ואירועים", image: meditationHands },
];
...
const Index = () => {
  return (
    <Layout>
      {/* Hero - Full-bleed image like Yoga Off East */}
        ...
        <div className="container mx-auto px-4 relative z-10 pb-20 md:pb-28 pt-40">
          ...
          >
            ...
            >
              יוגה
              <br />
              <span className="font-light italic opacity-90">במושבה</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="text-lg md:text-xl text-primary-foreground/80 leading-relaxed mb-10 max-w-lg"
            >
      ...
      {/* Welcome / About - Side-by-side like Feel Good Yoga */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="font-heading text-3xl md:text-5xl font-bold mb-6 leading-tight">
                מרחב של שקט
                <br />
                <span className="font-light italic text-primary">ונשימה</span>
              </h2>
              ...
              <div className="flex gap-10 mb-8 pt-6 border-t border-border">
                {[
            ...
            >
              <div className="rounded-3xl overflow-hidden shadow-2xl">
                <img src={teacherShira} alt="שירה פלג" className="w-full aspect-[3/4] object-cover" />
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-muted-foreground max-w-md mx-auto text-lg">
              מגוון אפשרויות שמותאמות לכל אחת ואחד
            </motion.p>
          </motion.div>
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <img src={yogaSunset} alt="יוגה בשקיעה" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-yoga-dark/50 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-primary-foreground/70 text-lg mb-8 max-w-md mx-auto">
              הצטרפו למשפחת יוגה במושבה ותגלו מרחב חדש של שקט ורוגע
            </p>
      ...
      <section className="py-24 md:py-36 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              <img src={yogaGroup} alt="תרגול קבוצתי" className="w-full aspect-square object-cover" />
            </motion.div>
            ...
            >
              ...
              <motion.h2 variants={fadeUp} className="font-heading text-3xl md:text-4xl font-bold mb-10">
                יתרונות התרגול
              </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 max-w-5xl mx-auto">
            ...
            >
              <motion.div variants={fadeUp}>
                <Input placeholder="שם מלא" className="bg-accent/30 border-0 rounded-xl h-12" />
              </motion.div>
              <motion.div variants={fadeUp}>
                <Input type="email" placeholder="אימייל" className="bg-accent/30 border-0 rounded-xl h-12" />
              </motion.div>
              <motion.div variants={fadeUp}>
                <Input type="tel" placeholder="טלפון" className="bg-accent/30 border-0 rounded-xl h-12" />
              </motion.div>
              <motion.div variants={fadeUp}>
                <Textarea placeholder="הודעה" rows={4} className="bg-accent/30 border-0 rounded-xl" />
              </motion.div>
              <motion.div variants={fadeUp}>
